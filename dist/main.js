...
const addIncome = (income,save,currency)=>{
    let storageIncome = (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)('UAH income');
    (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.removeFromLocalStorage)('UAH income');
    let total = 0;
