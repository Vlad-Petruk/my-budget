...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   calculatePotentialIncome: () => (/* binding */ calculatePotentialIncome),
/* harmony export */   incomeHandler: () => (/* binding */ incomeHandler),
/* harmony export */   onloadListener: () => (/* binding */ onloadListener),
/* harmony export */   totalAllCalculate: () => (/* binding */ totalAllCalculate)
/* harmony export */ });
...
const onloadListener = () =>{
    window.addEventListener('load',()=>{
        let potentialTotal = (0,_local_storage__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)('potential monthly income');
        if(potentialTotal !== null){
            potentialIncTotal.textContent = `Potential 2 week total: ${potentialTotal.value}`;
        }
        let UAHtotal = (0,_local_storage__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)('UAH income');
        let USDtotal = (0,_local_storage__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)('USD income');
        ...
        let oweMe = (0,_local_storage__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)('Lent money');
        if (oweMe !== null){
...
startNewPeriod.addEventListener('click',()=>{
    ;(0,_local_storage__WEBPACK_IMPORTED_MODULE_1__.removeFromLocalStorage)('potential monthly income');
    potentialIncTotal.textContent = `Potential 2 week total: 0`
})

const calculatePotentialIncome = () =>{
    let value = potentialIncInput.value;
    let use = (0,_factories__WEBPACK_IMPORTED_MODULE_0__.sushiCashIntoSalary)(value,'Nov 20');
    ...
    let total = (0,_factories__WEBPACK_IMPORTED_MODULE_0__.potentialMonthlyIncome)(use.dailySalary);
...
lentBtn.addEventListener('click', ()=>{
    (0,_factories__WEBPACK_IMPORTED_MODULE_0__.oweMeHandler)(lentInput, totalOwe,'lent')
})
returnedBtn.addEventListener('click', ()=>{
    ;(0,_factories__WEBPACK_IMPORTED_MODULE_0__.oweMeHandler)(returnedInput, totalOwe,'returned')
})
...
const incomeHandler = () => {
    ...
    if (selectedCurrency === 'USD') {
        (0,_factories__WEBPACK_IMPORTED_MODULE_0__.addIncome)(actualIncInput, totalUSD, 'USD');
    } else {
        (0,_factories__WEBPACK_IMPORTED_MODULE_0__.addIncome)(actualIncInput, totalUAH, 'UAH');
    }
};
...
/* harmony export */   oweMeHandler: () => (/* binding */ oweMeHandler),
...
const addIncome = (income,save,currency)=>{
    let storageIncome = (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(`${currency} income`);
    (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.removeFromLocalStorage)(`${currency} income`);
    let total = 0;
    ...
    (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(`${currency} income`, total);
}

const oweMeHandler = (money, save, operation)=>{
    let storageOwe = (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(`Lent money`);
    (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.removeFromLocalStorage)(`Lent money`);
    let total = 0;
    ...
    (0,_local_storage__WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(`Lent money`, total);
}
...
function addToLocalStorage(key, value) {
    try {
        const timestamp = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((new Date),'PP');
...
(0,_UI__WEBPACK_IMPORTED_MODULE_2__.onloadListener)()
